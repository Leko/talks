...
コメントの書式は[codecov](https://codecov.io)というサービスを真似た

<img src="/assets/circleci-artifacts/2019-06-19-21-51-36.png" />
...
- 直接影響のあるところだけ動作確認するのは容易
- スタイル修正したときにデグレってないか影響範囲を目検...？
  - コンポーネント数十個、更にストーリーが4-5個  
  - 500パターン全部をPRのたびに全部チェック？
- じゃあ確認しきるのを諦める？
